        ...
        ({ prefix, host }) => {
            function rewriteAssetUrl(val) {
                ...
                try {
                    ...
                    // Keep third-party/CDN URLs untouched (important for module chains).
                    // Rewrite only first-party Brother hosts to local assets.
                    const isFirstParty =
                        abs.hostname === host || abs.hostname.endsWith('.brother-usa.com');
