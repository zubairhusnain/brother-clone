 ...
 */
const { sanitizeOfflinePageHtml } = require('./sanitize-offline-header.js');
const {
    normalizeMalformedPageHtml,
    injectBeforeHeadClose,
} = require('./normalize-page-html.js');
...
function fixPageHtml(html, pageRel, prefix) {
    ...
    if (!html.includes('offline-header-fix.css')) {
        html = injectBeforeHeadClose(
            html,
            `    <link rel="stylesheet" href="${prefix}assets/css/offline-header-fix.css" type="text/css">`
        );
    }
